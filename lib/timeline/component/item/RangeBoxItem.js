 ...
 * @extends Item
 */
class RangeBoxItem extends Item {
  /**
 ...
 */
  ...
  repositionX(limitSize) {
    ...
    switch (align) {
      case 'left':
        ...
        this.dom.dot.style.transform = `translateX(${this.start+lineWidth/2-dotWidth/2}px)`;
        this.dom.line.style.transform = `translateX(${this.start}px)`;
        break;
      ...
      case 'right':
        ...
        this.dom.dot.style.transform = `translateX(${this.start-lineWidth/2-dotWidth/2}px)`;
        this.dom.line.style.transform = `translateX(${this.start-lineWidth}px)`;
        break;
      ...
      case 'center':
        ...
        this.dom.dot.style.transform = `translateX(${start - dotWidth / 2}px)`;
        this.dom.line.style.transform = `translateX(${this.options.rtl ? start - lineWidth : start - lineWidth / 2}px)`;        
        break;
  ...
  repositionY() {
    ...
    if (orientation == 'top') {
      ...
      const lineHeight = this.parent.itemSet.props.height - this.parent.top - this.parent.height + this.top;
      lineStyle.height = `${lineHeight}px`;
      lineStyle.top = '';
      lineStyle.bottom = '0';
    }
    this.dom.dot.style.transform = `translateY(${-this.props.dot.height / 2}px)`;
  }
...
RangeBoxItem.prototype.baseClassName = 'vis-item vis-rangebox';
