 ...
 */
  ...
  repositionX(limitSize) {
    ...
    if (this.options.rtl) {
      ...
      this.dom.dot.style.transform = `translate(${(this.right-this.props.dot.width/2)* -1}px,${-this.props.dot.height / 2}px)`;
      this.dom.line.style.transform = `translateX(${this.right * -1}px)`;
    } else {
      this.dom.box.style.transform = `translateX(${this.left}px)`;
      this.dom.dot.style.transform = `translate(${this.left-this.props.dot.width/2}px,${-this.props.dot.height / 2}px)`;
      this.dom.line.style.transform = `translateX(${this.left}px)`;
    }
